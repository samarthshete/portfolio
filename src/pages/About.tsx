    ...
    <div className="min-h-screen py-20">
      <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-semibold text-foreground dark:text-white mb-8">
            Skills & Technologies
          </h2>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-primary to-accent dark:from-accent dark:to-primary rounded-2xl p-8 text-center text-white"
        >
          ...
          <a
            href="/contact"
            className="inline-block px-8 py-3 bg-white text-primary dark:text-accent font-medium rounded-lg hover:shadow-lg transition-all"
          >
            Get in Touch
          </a>
        </motion.div>
