...
const experiences = [
  {
    ...
    description:
      'Contributing to RAG document processing, LLM fine-tuning, and vector search components for enterprise document intelligence.',
    achievements: [
      'Contributed to a RAG-based document processing pipeline using LangChain and OpenAI APIs, supporting semantic search across a large enterprise document repository',
      'Assisted in fine-tuning an open-source LLM (Llama-2) on proprietary customer support data using Hugging Face Transformers and PyTorch, working with the team to evaluate response accuracy improvements',
      'Building vector search components using Pinecone and PostgreSQL pgvector, and collaborating with senior engineers on early-stage multi-agent workflow prototypes using the AutoGen framework',
    ],
    technologies: [
      'Python',
      'LangChain',
